...
type Extensions struct {
	...
	AdditionalProp2 *AdditionalProp2 `json:"additionalProp2,omitempty"`
	AdditionalProp3 *AdditionalProp3 `json:"additionalProp3,omitempty"`
}
